    ...
    public boolean isHappy(int n) {
        ...
        while (hset.add(n)) {
            ...
            while (n > 0) {
                ...
                // We use division and modulus operators to repeatedly take digits off the
                // number until none remain...
        ...
        // If current number is already in the HashSet, that means we're in a cycle and
