...
class Solution {
    public int wiggleMaxLength(int[] nums) {
        ...
        // Java boolean allows values of true and false while Boolean allows true,
        // false, and null
        ...
        for (int i = 0; i < nums.length - 1; i++) {
            ...
            if (temp == 0)
                ans--;// when we encounter a diff of 0, we decrement the ans i.e we don't consider
                      // that element in our answer sequence
