    ...
    public int longestConsecutive(int[] nums) {
        ...
        for (int i = 1; i < size; i++) {
            ...
            if (nums[i] == nums[i - 1]) {
                ...
                current_longest = 1; // we can't extend so update longest as the maximum of the both and reset the
                                     // current_longest.
            }
...
class Solution {
    public int longestConsecutive(int[] nums) {
        ...
        // doesnt matter how many times a number is present
        for (int i : nums) {
            // the idea is to assume the present value "i" the center of the sequence in
            // which it is present
            ...
            int max = 1, prevVal = i - 1, nextVal = i + 1; // max is the current length as we have one elemet in the
                                                           // sequence that is 5
            // now for 5 prevVal = 4
            ...
            // removing the elements because an element can only be part of only one
